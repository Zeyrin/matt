...
export default function Manifesto() {
  ...
  return (
    <section ref={ref} id="story" className="relative overflow-hidden py-28 md:py-40">
      ...
      <div className="relative mx-auto grid max-w-[1500px] gap-16 px-5 md:px-10 lg:grid-cols-12">
        <div className="lg:col-span-7">
          <Eyebrow>The man behind the lens</Eyebrow>
          <h2 className="font-display mt-8 text-4xl font-light leading-[1.12] text-foam md:text-6xl">
            ...
            <Reveal delay={0.15}>
              <div className="group relative" data-cursor-label="Matt">
                ...
                <div className="relative overflow-hidden rounded-sm">
                  <motion.img src="/img/portrait.jpg" alt="Underwater videographer Matt Baer" loading="lazy" decoding="async" style={{ y: imgY }} className="img-deep h-[540px] w-full scale-110 object-cover will-change-transform" />
